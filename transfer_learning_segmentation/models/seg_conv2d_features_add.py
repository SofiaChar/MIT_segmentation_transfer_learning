...
class SegModelConv2DFeatures(nn.Module):
    def __init__(self):
        ...
        self.bnorm10 = BNormBlock(160, 64, (3, 3), padding='same')
        self.bnorm11 = BNormBlock(64, 64, (3, 3), padding='same')
        self.bnorm12 = BNormBlock(64, 64, (3, 3), strides=2)
        self.drop4 = nn.Dropout(0.2)

        self.bnorm13 = BNormBlock(256, 64, (3, 3), padding='same')

        #BottleNeck
        self.bnorm14 = BNormBlock(128, 64, (3, 3), padding='same', dilate=2)
