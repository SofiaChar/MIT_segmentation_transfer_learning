...
class HumanSegModel4Improve(nn.Module):
    def __init__(self):
        ...
        self.bnorm1_1 = BNormBlock(16, 16, (3, 3), strides=1,padding='same')
    ...
    def forward(self, inputs, mask, features):
        ...
        encoder_9 = features[:, :32, :, :]
        encoder_11 = features[:, 32:64, :, :]
        decoder_1 = features[:, 64:96, :, :]
        decoder_2 = features[:, 96:, :, :]

        print('encoder_9', encoder_9.shape)
        print('encoder_11', encoder_11.shape)
        ...
        features_1 = nn.Upsample((64, 64))(encoder_9)  # ([8, 32, 64, 64])
        ...
        features_2 = encoder_11  # ([8, 32, 32, 32])
        ...
        features_3 = decoder_1  # ([8, 32,  32, 32])
        ...
        features_4 = nn.Upsample((64, 64))(decoder_2)  # ([8, 32, 64, 64])
